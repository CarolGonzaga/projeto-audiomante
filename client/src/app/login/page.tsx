...
export default function AuthPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        let apiResponse: AxiosResponse | null = null;
        let apiError: Error | AxiosError<{ error: string }> | null = null;
                ...
                <div className="relative w-full h-[40vh] md:h-[35vh] lg:h-screen lg:w-3/5 xl:w-1/2 bg-[#4d3859] lg:p-10 flex flex-col justify-start pt-6 lg:pt-[20vh] lg:pr-40 items-center text-white text-center overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center w-full max-w-md">
                        <Image
                            ...
                            width={250}
                            height={250}
                            className="mx-auto w-[100px] h-[100px] mb-4          // Mobile (base)
                                   md:w-[150px] md:h-[150px]                 // Tablet (medium)
                                   lg:w-[250px] lg:h-[250px] lg:mb-20"
                            priority
                        />
                ...
                <div className="relative w-full flex-grow lg:w-2/5 xl:w-1/2 bg-[#fffaf7] p-8 md:p-12 lg:p-2 lg:mr-20 flex flex-col justify-center items-center">
                    <div className="w-full max-w-md">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                ...
                                <button
                                    ...
                                    className="bg-white/80 w-full py-3 px-4 font-semibold rounded-lg border border-gray-300 hover:bg-gray-100 text-[#4d3859] transition"
                                >
                        ...
                        <div className="flex items-center my-10">
                            <div className="flex-1 h-px bg-[#d6d2d8]" />
                            <span className="mx-6 text-sm text-gray-500">ou</span>
                            <div className="flex-1 h-px bg-[#d6d2d8]" />
                        </div>
                        <button
